...
# --- Configuration ---
TOKEN = "8699525997:AAHK0NNYAase-mT7PTWdTxI5ucECbErwhik"
OWNER_ID = 7007926290
...
async def show(update, context):
    ...
    if mode == "win1": pool = ["5", "3", "9", "10"] if val == "1" else ["A", "K", "7", "4", "J"]
    elif mode == "win2": pool = ["A", "K", "Q", "J"] if val == "1" else ["10", "Q", "K", "9"]
    else: pool = RANKS
